...
const api: DesktopApi = {
  ...
  sendPrompt: async (projectId, sessionId, input, mode, attachments, delivery) => await ipcRenderer.invoke(desktopIpc.sendPrompt, projectId, sessionId, input, mode, attachments, delivery),
  ...
  skillCatalog: async () => await ipcRenderer.invoke(desktopIpc.skillCatalog),
