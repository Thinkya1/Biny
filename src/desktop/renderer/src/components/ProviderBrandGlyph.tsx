...
import alibabaCloudBrand from "../assets/provider-brands/alibabacloud.svg";
import cerebrasBrand from "../assets/provider-brands/cerebras.svg";
import cloudflareBrand from "../assets/provider-brands/cloudflare.svg";
import cohereBrand from "../assets/provider-brands/cohere.svg";
...
// Static vendor marks are vendored from Maka so the desktop renderer keeps
// their precise silhouettes without depending on its source tree at runtime.
export function ProviderBrandGlyph({ type }: { type: string }): React.JSX.Element {
  const gradientPrefix = useId().replace(/:/g, "");

  if (type === "anthropic") {
    return (
      <svg aria-hidden="true" className="provider-logo" viewBox="0 0 24 24">
        <path
  ...
  if (type === "deepseek") {
    return (
      <svg aria-hidden="true" className="provider-logo" fill="currentColor" viewBox="0 0 24 24">
  ...
  if (type === "gemini") {
    const shape = "M20.616 10.835a14.147 14.147 0 01-4.45-3.001 14.111 14.111 0 01-3.678-6.452.503.503 0 00-.975 0 14.134 14.134 0 01-3.679 6.452 14.155 14.155 0 01-4.45 3.001c-.65.28-1.318.505-2.002.678a.502.502 0 000 .975c.684.172 1.35.397 2.002.677a14.147 14.147 0 014.45 3.001 14.112 14.112 0 013.679 6.453.502.502 0 00.975 0c.172-.685.397-1.351.677-2.003a14.145 14.145 0 013.001-4.45 14.113 14.113 0 016.453-3.678.503.503 0 000-.975 13.245 13.245 0 01-2.003-.678z";
    return (
      <svg aria-hidden="true" className="provider-logo" viewBox="0 0 24 24">
        <path d={shape} fill="#3186FF" />
        <path d={shape} fill={`url(#${gradientPrefix}-green)`} />
        <path d={shape} fill={`url(#${gradientPrefix}-red)`} />
        <path d={shape} fill={`url(#${gradientPrefix}-yellow)`} />
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id={`${gradientPrefix}-green`} x1="7" x2="11" y1="15.5" y2="12">
            <stop stopColor="#08B962" />
            <stop offset="1" stopColor="#08B962" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id={`${gradientPrefix}-red`} x1="8" x2="11.5" y1="5.5" y2="11">
            <stop stopColor="#F94543" />
            <stop offset="1" stopColor="#F94543" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id={`${gradientPrefix}-yellow`} x1="3.5" x2="17.5" y1="13.5" y2="12">
  ...
  const asset = providerBrandAssets[type];
  if (asset) {
    return <img alt="" aria-hidden="true" className="provider-logo provider-logo-image" draggable={false} src={asset} />;
  }

  if (type === "siliconflow") {
    return (
      <svg aria-hidden="true" className="provider-logo" fill="currentColor" fillRule="evenodd" viewBox="0 0 24 24">
        <path clipRule="evenodd" d="M22.956 6.521H12.522c-.577 0-1.044.468-1.044 1.044v3.13c0 .577-.466 1.044-1.043 1.044H1.044c-.577 0-1.044.467-1.044 1.044v4.174C0 17.533.467 18 1.044 18h10.434c.577 0 1.044-.467 1.044-1.043v-3.13c0-.578.466-1.044 1.043-1.044h9.391c.577 0 1.044-.467 1.044-1.044V7.565c0-.576-.467-1.044-1.044-1.044z" />
      </svg>
    );
  }
